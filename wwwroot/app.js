...
function updateSelected(){const local=state.includeServerPc&&state.localPcComponent?.compatible;$('#selectedCount').textContent=`${state.selected.size+(local?1:0)} onboard · ${state.skipped.size} standalone`;$('#buildPlan').disabled=!state.selected.size&&!local}
