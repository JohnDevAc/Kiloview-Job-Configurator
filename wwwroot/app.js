...
function renderMonitor(app){
  ...
  const remotePcCard=pc=>{
    ...
    const {agentProduct,online,offline,stale,statusLabel,healthClass,statusClass,connectivityTitle}=windowsConnectivity(pc,agent);
